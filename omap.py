...
def runAllTests(directory, ipaddr, debugFlag=False):
    ...
    cameradar()
    nmapQuickScan(1000, 10000, 'tcp')
    nmapQuickScan(1000, 10000, 'udp')
    nmapBasicScan(1000, 10000, 'tcp')
    nmapBasicScan(1000, 10000, 'udp')
    nmapDepthScan(1000, 10000, 'tcp')
    nmapDepthScan(1000, 10000, 'udp')
